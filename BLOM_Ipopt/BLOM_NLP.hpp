...
#include "Sparse++/include/compcol_double.h"
#include "Sparse++/include/comprow_double.h"
#include "Sparse++/include/ilupre_double.h"
#include "Sparse++/include/icpre_double.h"
#include "Sparse++/include/iotext_double.h"
...
public:
  ...
  virtual bool eval_jac_g(Index n, const Number* x, bool new_x,
                          ...
                          Number* values);
  bool eval_jac_g_idx(Index n, const Number* x, bool new_x,
          Index m, Index nele_jac, Index* iRow, Index *jCol,
          Number* values);
  bool eval_jac_g_val(Index n, const Number* x, bool new_x,
          Index m, Index nele_jac, Index* iRow, Index *jCol,
          Number* values);
  /** Method to return:
...
private:
  ...
  void CalcConstraintsValues(Number values[],const Number x[]) ;
 
  void CalcJacobianValues(Number values[],const Number x[]);
  void GetJacobianStruct(int iRow[],int jCol[]);
